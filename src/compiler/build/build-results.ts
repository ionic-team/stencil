...
import { cleanDiagnostics, hasError } from '@utils';
...
// function getEntryModule(config: d.Config, _buildCtx: d.BuildCtx, en: d.EntryModule) {
//   return getBuildEntry(config, [], en);
