...
describe('slot-no-default', function () {
    ...
    beforeEach(function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, setupDom('/slot-no-default/index.html')];
                case 1:
                    app = _a.sent();
                    return [2 /*return*/];
            }
    ...
    it('only renders slots that havea location', function () { return __awaiter(_this, void 0, void 0, function () {
        var root, a, header, main, nav, footer;
        return __generator(this, function (_a) {
            root = app.querySelector('slot-no-default');
