...
describe('lifecycle-on-ready', function() {
  ...
  it('fire load methods in order', async () => {
    ...
    expect(loads[7].textContent).toBe('lifecycle-on-ready-b componentDidLoad 1');
    expect(loads[8].textContent).toBe('lifecycle-on-ready-a componentDidUpdate 1');
    expect(loads[9].textContent).toBe('async add child components to lifecycle-on-ready-a 2');
    expect(loads[10].textContent).toBe('lifecycle-on-ready-a componentWillUpdate 2');
    expect(loads[11].textContent).toBe('lifecycle-on-ready-b componentWillLoad 2');
    expect(loads[12].textContent).toBe('lifecycle-on-ready-c componentWillLoad 2');
    expect(loads[13].textContent).toBe('lifecycle-on-ready-c componentDidLoad 2');
    expect(loads[14].textContent).toBe('lifecycle-on-ready-b componentDidLoad 2');
    expect(loads[15].textContent).toBe('lifecycle-on-ready-a componentDidUpdate 2');
  });
