...
- [Breaking Changes](#breaking-changes)
  - [Versions](#versions)
  - [Stencil v4.0.0](#stencil-v400)
    - [General](#general)
      - [Legacy Browser Support Fields Removed](#legacy-browser-support-fields-removed)
        - [`__deprecated__cssVarsShim`](#__deprecated__cssvarsshim)
        - [`__deprecated__dynamicImportShim`](#__deprecated__dynamicimportshim)
        - [`__deprecated__safari10`](#__deprecated__safari10)
        - [`__deprecated__shadowDomShim`](#__deprecated__shadowdomshim)
  - [Stencil v3.0.0](#stencil-v300)
    - [General](#general-1)
  ...
  - [Stencil Two](#stencil-two)
    - [BREAKING CHANGES](#breaking-changes-1)
      - [Opt-in for IE11, Edge 16-18 and Safari 10 Builds](#opt-in-for-ie11-edge-16-18-and-safari-10-builds)
      - [Opt-in for ES5 and SystemJS Builds](#opt-in-for-es5-and-systemjs-builds)
      - [Use `disconnectedCallback()` instead of `componentDidUnload()`](#use-disconnectedcallback-instead-of-componentdidunload)
      - [Default to `async` task queue](#default-to-async-task-queue)
      - [Restore Stencil 1 defaults](#restore-stencil-1-defaults)
      - [dist package.json](#dist-packagejson)
      - [NodeJS Update](#nodejs-update)
  - [Stencil One](#stencil-one)
    - [BREAKING CHANGES](#breaking-changes-2)
      - [Import `{ h }` is required](#import--h--is-required)
      - [index.html's `<script>`s updated to use `type="module"`](#indexhtmls-scripts-updated-to-use-typemodule)
      - [Collection's package.json](#collections-packagejson)
      - [Dependencies](#dependencies)
      - [`window.NAMESPACE` is no longer a thing](#windownamespace-is-no-longer-a-thing)
      - [`@Prop() mode` is no longer reserved prop](#prop-mode-is-no-longer-reserved-prop)
      - [Removed: Global `JSX`](#removed-global-jsx)
      - [Removed: Global `HTMLAttributes`](#removed-global-htmlattributes)
      - [Removed: Global `HTMLStencilElement`](#removed-global-htmlstencilelement)
      - [Removed: Global `StencilIntrinsicElement`](#removed-global-stencilintrinsicelement)
      - [Removed: @Listen('event.KEY’)](#removed-listeneventkey)
      - [Removed: @Listen('event’, { enabled })](#removed-listenevent--enabled-)
      - [Removed: @Listen('event’, { eventName })](#removed-listenevent--eventname-)
      - [Removed: @Component({ host })](#removed-component-host-)
      - [`mockDocument()` and `mockWindow()` has been moved](#mockdocument-and-mockwindow-has-been-moved)
    - [DEPRECATIONS](#deprecations)
      - [outputTarget "docs"](#outputtarget-docs)
      - [`hostData()`](#hostdata)
      - [All void methods return promise (right now method(): void is valid)](#all-void-methods-return-promise-right-now-method-void-is-valid)
        - [Given an example component like:](#given-an-example-component-like)
      - [`@Listen('TARGET:event’)`](#listentargetevent)
      - [`@Prop({context})`](#propcontext)
        - [`'window'`](#window)
        - [`'document'`](#document)
        - [`'isServer'`](#isserver)
      - [`@Prop(connect)`](#propconnect)
      - [`@Component.assetsDir`](#componentassetsdir)
      - [OutputTarget local copy tasks](#outputtarget-local-copy-tasks)
    - [New APIs](#new-apis)
      - [setMode() and getMode()](#setmode-and-getmode)
      - [getAssetsPath(this, relativePath)](#getassetspaththis-relativepath)
      - [`dist-module` output target](#dist-module-output-target)
    - [Testing](#testing)
      - [`newSpecPage()` Spec Testing Utility](#newspecpage-spec-testing-utility)
      - [Serialized `<mock:shadow-root>`](#serialized-mockshadow-root)
