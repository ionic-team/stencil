...
describe('slot array basic', function () {
    ...
    it('renders slotted content between header/footer', function () { return __awaiter(void 0, void 0, void 0, function () {
        var elm, hiddenCmp;
        return __generator(this, function (_a) {
            elm = app.querySelector('.results1');
