...
export const validateServiceWorker = (config, outputTarget) => {
    ...
    const globDirectory = typeof ((_a = outputTarget.serviceWorker) === null || _a === void 0 ? void 0 : _a.globDirectory) === 'string'
        ? outputTarget.serviceWorker.globDirectory
        : outputTarget.appDir;
    outputTarget.serviceWorker = {
        ...outputTarget.serviceWorker,
        globDirectory,
        swDest: isString((_b = outputTarget.serviceWorker) === null || _b === void 0 ? void 0 : _b.swDest)
            ? outputTarget.serviceWorker.swDest
            : join((_c = outputTarget.appDir) !== null && _c !== void 0 ? _c : '', DEFAULT_FILENAME),
    };
    ...
    if (isString(outputTarget.serviceWorker.swDest) && !isAbsolute(outputTarget.serviceWorker.swDest)) {
        outputTarget.serviceWorker.swDest = join((_d = outputTarget.appDir) !== null && _d !== void 0 ? _d : '', outputTarget.serviceWorker.swDest);
    }
};
/**
...
//# sourceMappingURL=validate-service-worker.js.map