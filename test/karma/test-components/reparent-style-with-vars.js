...
const reparentStyleWithVarsCss =
  ':root{--custom-color:blue}:host{background-color:var(--custom-color, blue);display:block;padding:2em}.css-entry{color:purple;font-weight:bold}';
...
const ReparentStyleWithVars$1 = class extends HTMLElement {
  ...
  static get style() {
    return reparentStyleWithVarsCss;
  }
};

const ReparentStyleWithVars = /*@__PURE__*/ proxyCustomElement(ReparentStyleWithVars$1, [
  1,
  'reparent-style-with-vars',
]);
