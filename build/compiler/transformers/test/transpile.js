 ...
 */
export function transpileModule(input, config, compilerCtx, beforeTransformers = [], afterTransformers = [], afterDeclarations = [], tsConfig = {}, inputFileName = 'module.tsx') {
    const options = {
 ...
 */
const prettifyTSOutput = (tsOutput) => tsOutput.replace(/\s+/gm, ' ');
/**
 ...
 */
export function getStaticGetter(stringifiedJs, propertyName) {
