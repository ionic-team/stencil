...
import { APP_DATA_CONDITIONAL, STENCIL_CORE_ID, STENCIL_INTERNAL_CLIENT_ID, STENCIL_INTERNAL_CLIENT_PATCH_BROWSER_ID, STENCIL_INTERNAL_HYDRATE_ID, STENCIL_INTERNAL_ID, } from './entry-alias-ids';
export const coreResolvePlugin = (config, compilerCtx, platform, externalRuntime) => {
...
export const getStencilInternalModule = (config, compilerExe, internalModule) => {
...
//# sourceMappingURL=core-resolve-plugin.js.map