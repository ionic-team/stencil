 ...
 */ function queryNonceMetaTagContent(t) {
  var e, o, l;
  return null !== (l = null === (o = null === (e = t.head) || void 0 === e ? void 0 : e.querySelector('meta[name="csp-nonce"]')) || void 0 === o ? void 0 : o.getAttribute("content")) && void 0 !== l ? l : void 0;
}

var getDynamicImportFunction = function(t) {
  return "__sc_import_".concat(t.replace(/\s|-/g, "_"));
}, patchBrowser = function() {
  // shim css vars
  plt.$cssShim$ = win.__cssshim, 
  // opted-in to polyfill cloneNode() for slot polyfilled components
  patchCloneNodeFix(H.prototype);
  // @ts-ignore
  var t = Array.from(doc.querySelectorAll("script")).find((function(t) {
    return new RegExp("/".concat(NAMESPACE, "(\\.esm)?\\.js($|\\?|#)")).test(t.src) || t.getAttribute("data-stencil-namespace") === NAMESPACE;
  })), e = t["data-opts"] || {};
  return "onbeforeload" in t && !history.scrollRestoration /* IS_ESM_BUILD */ ? {
    then: function() {
      /* promise noop */}
  } : (e.resourcesUrl = new URL(".", new URL(t.getAttribute("data-resources-url") || t.src, win.location.href)).href, 
  patchDynamicImport(e.resourcesUrl, t), win.customElements ? promiseResolve(e) : import(/* webpackChunkName: "polyfills-dom" */ "./dom-70ce71ed.js").then((function() {
    return e;
  })));
}, patchDynamicImport = function(t, e) {
  var o = getDynamicImportFunction(NAMESPACE);
  try {
    // test if this browser supports dynamic imports
    // There is a caching issue in V8, that breaks using import() in Function
    // By generating a random string, we can workaround it
    // Check https://bugs.chromium.org/p/chromium/issues/detail?id=990810 for more info
    win[o] = new Function("w", "return import(w);//".concat(Math.random()));
  } catch (a) {
    ...
    var l = new Map;
    win[o] = function(a) {
      var s, r = new URL(a, t).href, c = l.get(r);
      if (!c) {
        var n = doc.createElement("script");
        n.type = "module", n.crossOrigin = e.crossOrigin, n.src = URL.createObjectURL(new Blob([ "import * as m from '".concat(r, "'; window.").concat(o, ".m = m;") ], {
          type: "application/javascript"
        }));
        // Apply CSP nonce to the script tag if it exists
        var i = null !== (s = plt.$nonce$) && void 0 !== s ? s : queryNonceMetaTagContent(doc);
        null != i && n.setAttribute("nonce", i), c = new Promise((function(t) {
          n.onload = function() {
            t(win[o].m), n.remove();
          };
        })), l.set(r, c), doc.head.appendChild(n);
      }
      return c;
    };
  }
}, patchCloneNodeFix = function(t) {
  var e = t.cloneNode;
  t.cloneNode = function(t) {
    if ("TEMPLATE" === this.nodeName) return e.call(this, t);
    var o = e.call(this, !1), l = this.childNodes;
    if (t) for (var a = 0; a < l.length; a++) 
    // Node.ATTRIBUTE_NODE === 2, and checking because IE11
    2 !== l[a].nodeType && o.appendChild(l[a].cloneNode(!0));
    return o;
  };
};

patchBrowser().then((function(t) {
  return globalScripts(), bootstrapLazy([ [ "custom-element-root", [ [ 1, "custom-element-root" ] ] ], [ "lifecycle-async-a", [ [ 0, "lifecycle-async-a", {
    ...
    value: [ 2 ]
  } ] ] ], [ "slot-light-list", [ [ 4, "slot-light-list" ] ] ], [ "slot-light-scoped-list", [ [ 4, "slot-light-scoped-list" ] ] ] ], t);
}));