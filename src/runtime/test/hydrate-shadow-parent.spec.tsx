...
describe('hydrate, shadow parent', () => {
  ...
  it('root level component, nested shadow slot', async () => {
    ...
    expect(serverHydrated.root).toEqualHtml(`
      <ion-tab-button data-hydrated s-id="1">
        <!--r.1-->
        <!--o.0.2.-->
        <a c-id="1.0.0.0">
          <!--s.1.1.1.0.-->
          <ion-badge data-hydrated c-id="0.2" s-id="2">
            <!--r.2-->
            <!--o.0.4.-->
            <!--s.2.0.0.0.-->
            <!--t.0.4-->
          ...
          <ion-ripple-effect data-hydrated c-id="1.2.1.1" s-id="3">
            <!--r.3-->
          </ion-ripple-effect>
        </a>
      </ion-tab-button>
    ...
    expect(clientHydrated.root).toEqualHtml(`
      <ion-tab-button data-hydrated>
        <mock:shadow-root>
          <a>
            <slot></slot>
            <ion-ripple-effect data-hydrated>
              <mock:shadow-root>
              </mock:shadow-root>
            </ion-ripple-effect>
          </a>
