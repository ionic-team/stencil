...
describe('event-basic', function () {
    ...
    beforeEach(function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, setupDom('/event-custom-type/index.html')];
                case 1:
                    app = _a.sent();
                    return [2 /*return*/];
            }
    ...
    it('should dispatch an event on load', function () {
        expect(app.querySelector('#counter').textContent).toBe('1');
    });
    it('should emit a complex type', function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, util_1.waitForChanges)()];
                case 1:
                    _a.sent();
