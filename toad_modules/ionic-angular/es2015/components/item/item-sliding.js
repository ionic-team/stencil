...
export const /** @type {?} */ ITEM_SIDE_FLAG_NONE = 0;
export const /** @type {?} */ ITEM_SIDE_FLAG_LEFT = 1 << 0;
export const /** @type {?} */ ITEM_SIDE_FLAG_RIGHT = 1 << 1;
export const /** @type {?} */ ITEM_SIDE_FLAG_BOTH = ITEM_SIDE_FLAG_LEFT | ITEM_SIDE_FLAG_RIGHT;
/**
 * \@name ItemSliding
 * \@description
