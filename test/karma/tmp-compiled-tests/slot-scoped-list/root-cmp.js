...
exports.SlotListLightScopedRoot = void 0;
var core_1 = require("@stencil/core");
var SlotListLightScopedRoot = /** @class */ (function () {
    function SlotListLightScopedRoot() {
        this.items = [];
    }
    SlotListLightScopedRoot.prototype.needMore = function () {
        var newItems = [
    ...
    SlotListLightScopedRoot.prototype.render = function () {
        ...
        return ((0, core_1.h)("div", null,
            ...
            (0, core_1.h)("slot-dynamic-scoped-list", { items: this.items })));
    };
    __decorate([
        (0, core_1.Prop)({ mutable: true })
    ], SlotListLightScopedRoot.prototype, "items", void 0);
    SlotListLightScopedRoot = __decorate([
        (0, core_1.Component)({
            tag: 'slot-list-light-scoped-root',
        })
    ], SlotListLightScopedRoot);
    return SlotListLightScopedRoot;
}());
exports.SlotListLightScopedRoot = SlotListLightScopedRoot;
