...
export const getRollupOptions = (config, compilerCtx, buildCtx, bundleOpts) => {
    ...
    if ((_a = config.devServer) === null || _a === void 0 ? void 0 : _a.experimentalDevModules) {
    ...
    const rollupOptions = {
        ...
        output: {
            inlineDynamicImports: (_b = bundleOpts.inlineDynamicImports) !== null && _b !== void 0 ? _b : false,
        },
        plugins: [
        ...
        preserveEntrySignatures: (_c = bundleOpts.preserveEntrySignatures) !== null && _c !== void 0 ? _c : 'strict',
