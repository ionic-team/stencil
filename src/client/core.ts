...
if (Build.es5) {
  ...
  createPlatformClientLegacy(namespace, Context, window, document, resourcePath, hydratedCssClass);

} else {
  // es2015 build which does uses es module imports and dynamic imports
  createPlatformClient(namespace, Context, window, document, resourcePath, hydratedCssClass);
}
