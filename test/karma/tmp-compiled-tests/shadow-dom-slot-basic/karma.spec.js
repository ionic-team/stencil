...
describe('shadow-dom-slot-basic', function () {
    ...
    it('renders shadowRoot', function () { return __awaiter(void 0, void 0, void 0, function () {
        var elm;
        return __generator(this, function (_a) {
            elm = app.querySelector('shadow-dom-slot-basic');
