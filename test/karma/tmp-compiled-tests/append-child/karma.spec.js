...
describe('append-child', function () {
    ...
    beforeEach(function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, setupDom('/append-child/index.html')];
                case 1:
                    app = _a.sent();
                    return [2 /*return*/];
            }
    ...
    it('appends to correct slot', function () { return __awaiter(_this, void 0, void 0, function () {
        var btnDefault, btnH1, btnH6;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    btnDefault = app.querySelector('#btnDefault');
                    btnDefault.click();
                    btnDefault.click();
                    btnH1 = app.querySelector('#btnH1');
                    btnH1.click();
                    btnH1.click();
                    btnH6 = app.querySelector('#btnH6');
                    btnH6.click();
                    btnH6.click();
