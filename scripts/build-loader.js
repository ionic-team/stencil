...
content = `(function(win, doc, appNamespace, publicPath, appCore, appCorePolyfilled, hydratedCssClass, components) {

${content}

init(win, doc, appNamespace, publicPath, appCore, appCorePolyfilled, hydratedCssClass, components);
