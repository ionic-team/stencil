...
describe('renderer', () => {
    ...
    describe('created element', () => {
        ...
        it('should not affect subsequence element', () => {
            patch(vnode0, h('div', null, [h('svg', null, [h('title', null, 'Title'), h('circle', null)]), h('div', null)]));
            expect(hostElm.tagName).toEqual('DIV');
    ...
    describe('created trailing svg element', () => {
        it('should not affect subsequent created element', () => {
            ...
            patch(vnode1, h('div', null, [h('div', null, h('svg', null)), h('div', null)]));
...
//# sourceMappingURL=patch-svg.spec.js.map