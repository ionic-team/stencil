...
const mockPackageJson = (version) => JSON.stringify({
    version,
});
describe('node-lazy-require', () => {
    describe('NodeLazyRequire', () => {
        describe('ensure', () => {
            ...
            const jestTestRange = (maxVersion = '38.0.1') => ({
                jest: {
                    minVersion: '2.0.7',
            ...
            it.each(['2.0.7', '10.10.10', '38.0.1', '38.0.2', '38.5.17'])('should not error if installed package has a suitable major version (%p)', async (testVersion) => {
            ...
            it.each(['2.0.7', '10.10.10', '36.0.1', '38.0.2', '38.5.17'])('should never error with versions above minVersion if there is no maxVersion supplied (%p)', async (testVersion) => {
            ...
            it.each(['100.1.1', '38.0.1-alpha.0'])('should error if the installed version of a package is too high (%p)', async (version) => {
...
//# sourceMappingURL=node-lazy-require.spec.js.map