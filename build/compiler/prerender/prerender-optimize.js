...
export const inlineExternalStyleSheets = async (sys, appDir, doc) => {
...
export const minifyScriptElements = async (doc, addMinifiedAttr) => {
...
export const minifyStyleElements = async (sys, appDir, doc, currentUrl, addMinifiedAttr) => {
...
export const excludeStaticComponents = (doc, hydrateOpts, hydrateResults) => {
...
`
    .replace(/\n/g, '')
    .trim();
export const addModulePreloads = (doc, hydrateOpts, hydrateResults, componentGraph) => {
    if (!componentGraph) {
        return false;
    }
...
export const removeModulePreloads = (doc) => {
...
export const removeStencilScripts = (doc) => {
...
export const hasStencilScript = (doc) => {
    return !!doc.querySelector('script[data-stencil]');
};
export const hashAssets = async (sys, prerenderCtx, diagnostics, hydrateOpts, appDir, doc, currentUrl) => {
...
export const getAttrUrls = (attrName, attrValue) => {
    const srcValues = [];
...
export const setAttrUrls = (url, descriptor) => {
...
//# sourceMappingURL=prerender-optimize.js.map