 ...
 */
export function addToLibrary(type, typeName, checker, pathToTypeModule) {
 ...
 */
export function getTypeLibrary() {
    return TYPE_LIBRARY;
}
/**
 ...
 * `process.cwd()`)
 */
export function addFileToLibrary(config, filePath) {
    const options = {
    ...
    function exportedTypesInSourceFile(sourceFile, exportedTypeNodes = []) {
 ...
 */
export function getHomeModule(importer, importPath, options, compilerHost, program) {
    var _a;
    const module = ts.resolveModuleName(importPath, importer.fileName, options, compilerHost);
    const resolvedFileName = (_a = module === null || module === void 0 ? void 0 : module.resolvedModule) === null || _a === void 0 ? void 0 : _a.resolvedFileName;
    if (!resolvedFileName) {
        return undefined;
    }
 ...
 * cannot be found
 */
export function findTypeWithName(module, typeName) {
    let typeWithName;
 ...
 * if not
 */
export function getOriginalTypeName(identifier, checker) {
...
function getTypeDeclaration(checker, type) {
    ...
    const declaration = (_a = maybeSymbol === null || maybeSymbol === void 0 ? void 0 : maybeSymbol.declarations) === null || _a === void 0 ? void 0 : _a[0];
    if (declaration) {
...
function getTypeDocstring(type, checker) {
    const symbol = type === null || type === void 0 ? void 0 : type.symbol;
 ...
 */
const getTypeId = (pathToTypeModule, typeName) => {
...
function getSymbolForType(type) {
    ...
    if (type === null || type === void 0 ? void 0 : type.aliasSymbol) {
