...
describe('attribute-boolean', function () {
    ...
    beforeEach(function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, setupDom('/attribute-boolean/index.html')];
                case 1:
                    app = _a.sent();
                    return [2 /*return*/];
            }
    ...
    it('button click rerenders', function () { return __awaiter(_this, void 0, void 0, function () {
        var root, child, button;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    root = app.querySelector('attribute-boolean-root');
                    ...
                    child = root.querySelector('attribute-boolean');
