...
describe('output-utils tests', () => {
    describe('isValidConfigOutputTarget', () => {
        ...
        it.each(['', 'my-target-that-i-made-up', DIST_TYPES])('should return false for invalid config output type "%s"', (outputTargetType) => {
    ...
    describe('isEligiblePrimaryPackageOutputTarget', () => {
        it.each([
            ...
            const res = isEligiblePrimaryPackageOutputTarget({ type: outputTarget });
...
//# sourceMappingURL=output-target.spec.js.map