...
describe('slot array complex', function () {
    ...
    it('renders slotted content', function () { return __awaiter(void 0, void 0, void 0, function () {
        var result, hiddenCmp;
        return __generator(this, function (_a) {
            result = app.querySelector('main slot-array-complex');
