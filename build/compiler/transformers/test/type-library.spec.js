...
describe('type library', () => {
    ...
    it("should issue a warning if it can't find the specified file", () => {
        ...
        expect(warnMock).toHaveBeenCalledWith('docs-json: unable to gather type information from "fixtures/not-found.ts". Please double check this path exists relative to your project root.');
...
//# sourceMappingURL=type-library.spec.js.map