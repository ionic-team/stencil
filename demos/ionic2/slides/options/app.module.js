...
var E2EPage = (function () {
    ...
    E2EPage.prototype.onSlideWillChange = function (s) {
        console.log("onSlideWillChange: " + s);
    };
    E2EPage.prototype.onSlideDidChange = function (s) {
        console.log("onSlideDidChange: " + s);
    };
    E2EPage.prototype.onSlideDrag = function (s) {
        console.log("onSlideDrag: " + s);
    };
    E2EPage.prototype.ngAfterViewInit = function () {
        this.slider.paginationBulletRender = function (index, className) {
