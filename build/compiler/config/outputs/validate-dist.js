import { COPY, DIST_COLLECTION, DIST_GLOBAL_STYLES, DIST_LAZY, DIST_LAZY_LOADER, DIST_TYPES, getComponentsDtsTypesFilePath, isBoolean, isOutputTargetDist, isString, join, resolve, } from '@utils';
...
const validateOutputTargetDist = (config, o) => {
    ...
    const outputTarget = {
        ...
        transformAliasedImportPathsInCollection: isBoolean(o.transformAliasedImportPathsInCollection)
            ...
            : true,
        isPrimaryPackageOutputTarget: (_b = o.isPrimaryPackageOutputTarget) !== null && _b !== void 0 ? _b : false,
    };
...
//# sourceMappingURL=validate-dist.js.map