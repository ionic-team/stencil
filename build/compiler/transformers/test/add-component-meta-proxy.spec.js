...
describe('add-component-meta-proxy', () => {
    describe('createClassMetadataProxy()', () => {
        ...
        beforeEach(() => {
            ...
            classExpr = ts.factory.createClassExpression(undefined, 'MyComponent', undefined, [htmlElementHeritageClause], []);
            ...
            formatComponentRuntimeMetaSpy.mockImplementation((_compilerMeta, _includeMethods) => [0, 'tag-name']);
        ...
        it('returns a call expression', () => {
            const result = createClassMetadataProxy(stubComponentCompilerMeta(), classExpr);
