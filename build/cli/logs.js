 ...
 */
export const startupLog = (logger, task) => {
 ...
 */
export const startupLogVersion = (logger, task, coreCompiler) => {
    if (task === 'info' || task === 'serve' || task === 'version') {
        return;
    }
 ...
 */
export const loadedCompilerLog = (sys, logger, flags, coreCompiler) => {
 ...
 */
export const startupCompilerLog = (coreCompiler, config) => {
