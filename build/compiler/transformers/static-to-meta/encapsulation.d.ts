 ...
 */
export declare const parseStaticEncapsulation: (staticMembers: ts.ClassElement[]) => d.Encapsulation;
/**
 ...
 */
export declare const parseStaticShadowDelegatesFocus: (encapsulation: string, staticMembers: ts.ClassElement[]) => boolean | null;
