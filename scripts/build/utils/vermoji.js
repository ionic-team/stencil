...
exports.getLatestVermoji = exports.getVermoji = void 0;
 ...
 */
function getLatestVermoji(changelogPath) {
    let changelogContents = null;
    try {
        changelogContents = fs_extra_1.default.readFileSync(changelogPath, 'utf8');
    }
    catch (err) {
...
exports.getLatestVermoji = getLatestVermoji;
