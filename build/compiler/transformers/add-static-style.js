 ...
 */
export const addStaticStyleGetterWithinClass = (classMembers, cmp, commentOriginalSelector) => {
...
export const addStaticStylePropertyToClass = (styleStatements, cmp) => {
    ...
    if (styleLiteral) {
        const statement = ts.factory.createExpressionStatement(ts.factory.createAssignment(ts.factory.createPropertyAccessExpression(ts.factory.createIdentifier(cmp.componentClassName), 'style'), styleLiteral));
...
//# sourceMappingURL=add-static-style.js.map