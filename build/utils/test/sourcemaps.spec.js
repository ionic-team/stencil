import { getInlineSourceMappingUrlLinker, getSourceMappingUrlForEndOfFile, getSourceMappingUrlLinker, rollupToStencilSourceMap, } from '@utils';
describe('sourcemaps', () => {
    ...
    describe('getInlineSourceMappingUrlLinker', () => {
        it('returns a correctly formatted sourcemap', () => {
            expect(getInlineSourceMappingUrlLinker('{"version":3,"file":"sourcemaps.js","sourceRoot":"","sources":["sourcemaps.ts"],"names":[],"mappings":";;AAAA,mCAKgB;"}')).toBe('//# sourceMappingURL=data:application/json;charset=utf-8;base64,' +
        ...
        it('handles question marks in sourcemaps', () => {
            expect(getInlineSourceMappingUrlLinker('{"version":3,"file":"source?maps.js","sourceRoot":"","sources":["source?maps.ts"],"names":[],"mappings":";;AAAA,mCAKgB;"}')).toBe('//# sourceMappingURL=data:application/json;charset=utf-8;base64,' +
        ...
        it('handles slashes in sourcemaps', () => {
            expect(getInlineSourceMappingUrlLinker('{"version":3,"file":"source/maps.js","sourceRoot":"","sources":["source/maps.js.ts"],"names":[],"mappings":";;AAAA,mCAKgB;"}')).toBe('//# sourceMappingURL=data:application/json;charset=utf-8;base64,' +
