(function (factory) {
    ...
    exports.ITEM_SIDE_FLAG_NONE = 0;
    exports.ITEM_SIDE_FLAG_LEFT = 1 << 0;
    exports.ITEM_SIDE_FLAG_RIGHT = 1 << 1;
    exports.ITEM_SIDE_FLAG_BOTH = exports.ITEM_SIDE_FLAG_LEFT | exports.ITEM_SIDE_FLAG_RIGHT;
    /**
     * \@name ItemSliding
     * \@description
    ...
    var ItemSliding = (function () {
        ...
        Object.defineProperty(ItemSliding.prototype, "_itemOptions", {
            ...
            set: function (itemOptions) {
                ...
                for (var _i = 0, _a = itemOptions.toArray(); _i < _a.length; _i++) {
                    ...
                    if (side === exports.ITEM_SIDE_FLAG_LEFT) {
        ...
        ItemSliding.prototype.moveSliding = function (x) {
            ...
            switch (this._sides) {
                case exports.ITEM_SIDE_FLAG_RIGHT:
                    openAmount = Math.max(0, openAmount);
                    break;
                case exports.ITEM_SIDE_FLAG_LEFT:
                    openAmount = Math.min(0, openAmount);
                    break;
                case exports.ITEM_SIDE_FLAG_BOTH: break;
                case exports.ITEM_SIDE_FLAG_NONE: return;
                default:
                    (void 0) /* assert */;
                    break;
            }
