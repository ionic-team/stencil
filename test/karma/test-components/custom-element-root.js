...
const CustomElementRoot$1 = class extends HTMLElement {
  ...
  render() {
    ...
    return h(
      'div',
      null,
      h('h4', null, 'Basic Nested Component'),
      h('custom-element-child-a', null),
      h('h4', null, 'Optional Nested Component via String'),
      h(OptionalComponentStringTag, null)
    );
  }
};

const CustomElementRoot = /*@__PURE__*/ proxyCustomElement(CustomElementRoot$1, [
  1,
  'custom-element-root',
  { optionalComponentString: [32] },
]);
  ...
  components.forEach((cmp) => {
    switch (cmp) {
      ...
      case 'custom-element-child-a':
        ...
        if (!customElements.get(tagName)) {
          const CustomElementChildA$1 = /*@__PURE__*/ proxyCustomElement(CustomElementChildA, [
            1,
            'custom-element-root',
            { optionalComponentString: [32] },
          ]);
