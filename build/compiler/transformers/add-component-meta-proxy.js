...
const createComponentMetadataProxy = (compilerMeta) => {
    ...
    return ts.factory.createExpressionStatement(ts.factory.createCallExpression(ts.factory.createIdentifier(PROXY_CUSTOM_ELEMENT), [], [literalCmpClassName, literalMeta]));
};
/**
