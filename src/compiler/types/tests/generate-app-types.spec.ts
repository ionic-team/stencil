...
`,
  ...
  it('should handle type name collisions when defined in separate files', async () => {
    const compilerComponentMeta = stubComponentCompilerMeta({
      tagName: 'my-component',
      componentClassName: 'MyComponent',
...
`,
  ...
  it('should handle type name collisions when defined in the component files', async () => {
    const compilerComponentMeta = stubComponentCompilerMeta({
      tagName: 'my-component',
      componentClassName: 'MyComponent',
      jsFilePath: '/some/stubbed/path/a/my-component.js',
