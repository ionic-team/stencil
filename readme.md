...
Stencil is a Web Component compiler that generates vanilla, standards-compliant custom elements for faster apps that work in any framework (or none at all!)
