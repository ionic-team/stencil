...
describe('key-reorder', function () {
    ...
    beforeEach(function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, setupDom('/key-reorder/index.html')];
                case 1:
                    app = _a.sent();
                    return [2 /*return*/];
            }
    ...
    it('uses same nodes after reorder', function () { return __awaiter(_this, void 0, void 0, function () {
        var item0, item1, item2, item3, item4, button;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    item0 = app.querySelector('#item-0');
                    item1 = app.querySelector('#item-1');
                    item2 = app.querySelector('#item-2');
                    item3 = app.querySelector('#item-3');
                    item4 = app.querySelector('#item-4');
