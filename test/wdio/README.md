...
WebderiverIO tests live in subdirectories within `test/wdio` alongside the components that they test. This keeps everything colocated and tidy!
...
succintly describes the test (`svg-class`, `slot-nested-order`,
