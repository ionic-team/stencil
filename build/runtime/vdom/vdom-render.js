...
import { HTML_NS, isDef, SVG_NS } from '@utils';
 ...
 */
export const isSameVnode = (leftVNode, rightVNode) => {
 ...
 */
export const nullifyVNodeRefs = (vNode) => {
    if (BUILD.vdomRef) {
 ...
 */
export const renderVdom = (hostRef, renderFnResults, isInitialLoad = false) => {
    var _a, _b;
...
//# sourceMappingURL=vdom-render.js.map