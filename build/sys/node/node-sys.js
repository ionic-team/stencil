 ...
 */
export function createNodeSys(c = {}) {
    var _a;
    const prcs = (_a = c === null || c === void 0 ? void 0 : c.process) !== null && _a !== void 0 ? _a : global.process;
    const logger = c === null || c === void 0 ? void 0 : c.logger;
    ...
    const sys = {
        ...
        setupCompiler(c) {
            ...
            sys.watchDirectory = (p, callback, recursive) => {
                logger === null || logger === void 0 ? void 0 : logger.debug(`NODE_SYS_DEBUG::watchDir ${p}`);
                const tsFileWatcher = tsSysWatchDirectory(p, (fileName) => {
                    logger === null || logger === void 0 ? void 0 : logger.debug(`NODE_SYS_DEBUG::watchDir:callback dir=${p} changedPath=${fileName}`);
            ...
            sys.watchFile = (path, callback) => {
                logger === null || logger === void 0 ? void 0 : logger.debug(`NODE_SYS_DEBUG::watchFile ${path}`);
                const tsFileWatcher = tsSysWatchFile(path, (fileName, tsEventKind) => {
...
//# sourceMappingURL=node-sys.js.map