...
(function () {
  ...
  var TemplateInstanceBase = function (_Polymer$PropertyEffe) {
  ...
  }(Polymer.PropertyEffects(function () {
    function _class() {
  ...
  function createTemplatizerClass(template, options) {
    ...
    var klass = function (_base) {
      _inherits(klass, _base);
  ...
  function addPropagateEffects(template, options) {
    ...
    if (userForwardHostProp) {
      ...
      if (!klass) {
        var base = options.mutableData ? MutableDataTemplate : DataTemplate;
        klass = template._content.__templatizeTemplateClass = function (_base2) {
          _inherits(TemplatizedTemplate, _base2);
  ...
  var Templatize = {
    ...
    templatize: function templatize(template, owner, options) {
      ...
      if (!baseClass) {
        baseClass = template._content.__templatizeInstanceClass = createTemplatizerClass(template, options);
      }
     ...
     */
    modelForElement: function modelForElement(host, el) {
      var model = void 0;
      while (el) {
