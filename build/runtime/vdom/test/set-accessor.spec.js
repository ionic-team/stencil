...
describe('setAccessor for custom elements', () => {
    ...
    it('should set object property to child', () => {
        const oldValue = 'someval';
        const newValue = { some: 'obj' };
    ...
    it('should update svg attribute', () => {
        ...
        const oldValue = 'rotate(45 72 72)';
        const newValue = 'rotate(45 27 27)';
    ...
    it('should remove svg attribute', () => {
        ...
        const oldValue = 'rotate(45 27 27)';
        const newValue = undefined;
        setAccessor(elm, 'transform', oldValue, newValue, true, 0);
        expect(elm.transform).toBeUndefined();
...
describe('setAccessor for inputs', () => {
    describe('simple attributes', () => {
        describe('should not add attribute when prop is undefined or null', () => {
            function expectStraightForwardAttribute(propName, newValue, oldValue) {
    ...
    describe('special attributes', () => {
        describe('should not add attribute when prop is undefined or null', () => {
            function expectSpecialAttribute(propName, newValue, oldValue) {
                const inputElm = document.createElement('input');
                setAccessor(inputElm, propName, oldValue, newValue, false, 0);
        ...
        describe('should update when prop is defined', () => {
            function expectSpecialAttributeDefined(propName, newValue, oldValue) {
                const inputElm = document.createElement('input');
                setAccessor(inputElm, propName, oldValue, newValue, false, 0);
                expect(inputElm).toEqualAttributes({ [propName]: newValue.toString() });
                expect(inputElm[propName]).toBe(newValue);
            }
    ...
    describe('boolean attributes', () => {
        describe('should not add attribute when prop is undefined or null', () => {
            function expectBooleanAttribute(propName, newValue, oldValue) {
                const inputElm = document.createElement('input');
                setAccessor(inputElm, propName, oldValue, newValue, false, 0);
                expect(inputElm.hasAttribute(propName)).toBe(false);
            }
        ...
        describe('should update when prop is defined', () => {
            function expectBooleanAttributeDefined(propName, newValue, oldValue) {
                const inputElm = document.createElement('input');
                setAccessor(inputElm, propName, oldValue, newValue, false, 0);
    ...
    describe('min/max attributes', () => {
        describe('should not add attribute when prop is undefined or null', () => {
            function expectMinMaxAttribute(propName, newValue, oldValue) {
                const inputElm = document.createElement('input');
                setAccessor(inputElm, propName, oldValue, newValue, false, 0);
                expect(inputElm.hasAttribute(propName)).toBe(false);
            }
        ...
        describe('should update when prop is defined', () => {
            function expectMinMaxAttributeDefined(propName, newValue, oldValue) {
                const inputElm = document.createElement('input');
                setAccessor(inputElm, propName, oldValue, newValue, false, 0);
                expect(inputElm).toEqualAttributes({ [propName]: newValue.toString() });
                expect(inputElm[propName]).toBe(newValue.toString());
            }
...
//# sourceMappingURL=set-accessor.spec.js.map