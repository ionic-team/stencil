...
const SlotBasicRoot$1 = class extends HTMLElement {
  ...
  render() {
    return h(
      ...
      h('div', { class: 'inc' }, 'Rendered: ', this.inc),
      h('div', { class: 'results1' }, h('slot-basic', null, textA, textB)),
      h('div', { class: 'results2' }, h('slot-basic', null, textA, spanB)),
      h('div', { class: 'results3' }, h('slot-basic', null, textA, divB)),
      h('div', { class: 'results4' }, h('slot-basic', null, h('footer', null, textA, divB))),
      h('div', { class: 'results5' }, h('slot-basic', null, spanA, textB)),
      h('div', { class: 'results6' }, h('slot-basic', null, spanA, spanB)),
      h('div', { class: 'results7' }, h('slot-basic', null, spanA, divB)),
      h('div', { class: 'results8' }, h('slot-basic', null, divA, textB)),
      h('div', { class: 'results9' }, h('slot-basic', null, divA, spanB)),
      h('div', { class: 'results10' }, h('slot-basic', null, divA, divB)),
      h('div', { class: 'results11' }, h('slot-basic', null, divA, h('footer', null, divB), divC))
    );
  }
};
