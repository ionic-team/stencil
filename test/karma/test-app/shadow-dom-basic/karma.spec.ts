...
describe('shadow-dom-basic', function() {
  ...
  function testPolyfilledShadow(elm: Element) {
    ...
    expect(elm.classList.contains('sc-shadow-dom-basic-root-host')).toBe(true);
    ...
    expect(elm.children[0].classList.contains('sc-shadow-dom-basic-host')).toBe(true);
    expect(elm.children[0].classList.contains('sc-shadow-dom-basic-slot')).toBe(true);
