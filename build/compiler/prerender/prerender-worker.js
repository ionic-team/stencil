...
import { addModulePreloads, excludeStaticComponents, hashAssets, minifyScriptElements, minifyStyleElements, removeModulePreloads, removeStencilScripts, } from './prerender-optimize';
import { getPrerenderCtx } from './prerender-worker-ctx';
export const prerenderWorker = async (sys, prerenderRequest) => {
    // worker thread!
    const results = {
        diagnostics: [],
        anchorUrls: [],
...
//# sourceMappingURL=prerender-worker.js.map