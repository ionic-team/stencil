...
const ReflectNanAttribute = class {
  constructor(hostRef) {
  ...
  render() {
    this.renderCount += 1;
    return index.h("div", null, "reflect-nan-attribute Render Count: ", this.renderCount);
  }
  componentDidUpdate() {
...
exports.reflect_nan_attribute = ReflectNanAttribute;
