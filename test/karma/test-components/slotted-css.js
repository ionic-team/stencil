  ...
  render() {
    return h(
      ...
      h(
        'section',
        null,
        h('header', null, h('slot', { name: 'header-slot-name' })),
        h('section', { class: 'content' }, h('slot', null)),
        h('footer', null, h('slot', { name: 'footer-slot-name' }))
      )
    );
  }
  static get style() {
