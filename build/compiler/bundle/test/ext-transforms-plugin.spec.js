...
describe('extTransformsPlugin', () => {
    function setup(bundleOptsOverrides = {}) {
    ...
    describe('transform function', () => {
        ...
        describe('passing `commentOriginalSelector` to `transformCssToEsm`', () => {
            ...
            it.each(['tag=my-component&encapsulation=scoped', 'tag=my-component&encapsulation=shadow', 'tag=my-component'])('should pass false if %p without hydrate', async (queryParams) => {
...
//# sourceMappingURL=ext-transforms-plugin.spec.js.map