...
describe('tag-names', function () {
    ...
    beforeEach(function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, setupDom('/dynamic-imports/index.html')];
                case 1:
                    app = _a.sent();
                    return [2 /*return*/];
            }
    ...
    it('should load content from dynamic import', function () { return __awaiter(void 0, void 0, void 0, function () {
        var dynamicImport;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    dynamicImport = app.querySelector('dynamic-import');
