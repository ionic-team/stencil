...
describe('conditional-basic', function () {
    ...
    beforeEach(function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, setupDom('/conditional-basic/index.html')];
                case 1:
                    app = _a.sent();
                    return [2 /*return*/];
            }
    ...
    it('contains a button as a child', function () { return __awaiter(_this, void 0, void 0, function () {
        var button;
        return __generator(this, function (_a) {
    ...
    it('button click rerenders', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    button = app.querySelector('button');
                    results = app.querySelector('div.results');
