...
describe('release-utils', () => {
  describe('postGithubRelease', () => {
    ...
    it('splits a minor release from a previous patch release', async () => {
      const minorReleaseFollowingPatch = `# 🍣 [2.13.0](https://github.com/stenciljs/core/compare/v2.12.1...v2.13.0) (2022-01-24)
...
`;
    ...
    it('splits a minor release from a previous minor release', async () => {
      const minorReleaseFollowingMinor = `# ⛸ [2.12.0](https://github.com/stenciljs/core/compare/v2.11.0...v2.12.0) (2021-12-13)
...
`;
    ...
    it('splits a patch release from a previous patch release', async () => {
      const patchReleaseFollowingPatch = `## ♨️ [2.12.2](https://github.com/stenciljs/core/compare/v2.12.1...v2.12.2) (2022-01-24)
