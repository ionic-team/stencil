 ...
 */
export const generateCustomElementsTypes = async (config, compilerCtx, buildCtx, typesDir) => {
        ...
        ...(isBarrelExport
            ? [
                ...
                ...components.map((component) => {
                    ...
                    return [
                        `export { ${importName} as ${exportName} } from '${componentDTSPath.startsWith('.') ? componentDTSPath : './' + componentDTSPath}';`,
...
//# sourceMappingURL=custom-elements-types.js.map