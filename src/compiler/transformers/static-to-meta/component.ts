...
export const parseStaticComponentMeta = (config: d.Config, compilerCtx: d.CompilerCtx, _transformCtx: ts.TransformationContext, typeChecker: ts.TypeChecker, cmpNode: ts.ClassDeclaration, moduleFile: d.Module, nodeMap: d.NodeMap, _transformOpts: d.TransformOptions, fileCmpNodes: ts.ClassDeclaration[]) => {
