...
describe('listen-reattach', function () {
    ...
    it('should receive click events, remove/attach, and receive more events', function () { return __awaiter(void 0, void 0, void 0, function () {
        var clicked, elm, moveIt;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    clicked = app.querySelector('#clicked');
                    expect(clicked.textContent.trim()).toBe('Clicked: 0');
                    elm = app.querySelector('listen-reattach');
                    elm.click();
                ...
                case 2:
                    ...
                    moveIt = app.querySelector('#moveIt');
                    moveIt.click();
                    return [4 /*yield*/, (0, util_1.waitForChanges)()];
                case 3:
                    _a.sent();
