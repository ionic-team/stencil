...
import { LAZY_BROWSER_ENTRY_ID, LAZY_EXTERNAL_ENTRY_ID, STENCIL_APP_GLOBALS_ID, STENCIL_CORE_ID, STENCIL_INTERNAL_CLIENT_PATCH_BROWSER_ID, USER_INDEX_ENTRY_ID, } from '../../bundle/entry-alias-ids';
...
const getCustomBeforeTransformers = (config, compilerCtx) => {
    ...
    customBeforeTransformers.push(lazyComponentTransform(compilerCtx, transformOpts), removeCollectionImports(compilerCtx));
...
//# sourceMappingURL=lazy-output.js.map