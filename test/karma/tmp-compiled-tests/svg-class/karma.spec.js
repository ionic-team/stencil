...
describe('svg class', function () {
    ...
    beforeEach(function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, setupDom('/svg-class/index.html')];
                case 1:
                    app = _a.sent();
                    return [2 /*return*/];
            }
    ...
    it('toggles svg class', function () { return __awaiter(void 0, void 0, void 0, function () {
        var svg, circle, rect, button;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    svg = app.querySelector('svg');
                    circle = app.querySelector('circle');
