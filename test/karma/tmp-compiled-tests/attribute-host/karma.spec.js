...
describe('attribute-host', function () {
    ...
    beforeEach(function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, setupDom('/attribute-host/index.html')];
                case 1:
                    app = _a.sent();
                    return [2 /*return*/];
            }
    ...
    it('add/remove attrs', function () { return __awaiter(_this, void 0, void 0, function () {
        var elm, button, win;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    elm = app.querySelector('section');
