...
export const addLazyElementGetter = (classMembers, moduleFile, cmp) => {
    ...
    if (cmp.elementRef) {
        ...
        const getter = ts.factory.createGetAccessorDeclaration(undefined, cmp.elementRef, [], undefined, ts.factory.createBlock([
            ts.factory.createReturnStatement(ts.factory.createCallExpression(ts.factory.createIdentifier(GET_ELEMENT), undefined, [
...
//# sourceMappingURL=lazy-element-getter.js.map