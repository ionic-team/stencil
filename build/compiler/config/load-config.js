...
export const loadConfig = async (init = {}) => {
    ...
    try {
        ...
        const sys = (_a = init.sys) !== null && _a !== void 0 ? _a : createNodeSys();
 ...
 * will be returned.
 */
const loadConfigFile = async (diagnostics, configPath) => {
    let config = null;
 ...
 * will be returned.
 */
const evaluateConfigFile = async (diagnostics, configFilePath) => {
