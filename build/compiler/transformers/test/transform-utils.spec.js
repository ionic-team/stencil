...
import { isMemberPrivate, mapJSDocTagInfo, retrieveModifierLike, retrieveTsDecorators, retrieveTsModifiers, } from '../transform-utils';
describe('transform-utils', () => {
     ...
     */
    const createMemberWithModifiers = (modifiers = undefined) => {
        return ts.factory.createMethodDeclaration(modifiers, undefined, ts.factory.createIdentifier('myMethod'), undefined, undefined, [], undefined, ts.factory.createBlock([], false));
    };
...
//# sourceMappingURL=transform-utils.spec.js.map