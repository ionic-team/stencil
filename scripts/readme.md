...
Manual releases should only be performed when there are extenuating circumstances.
...
1. Run the [Stencil Production Release](https://github.com/ionic-team/stencil/actions/workflows/release-production.yml) in GitHub
   ...
   2. Stencil follows semantic versioning. Select the semver-appropriate version from the drop down for this release
...
:warning: Manual releases should only be performed when there are extenuating circumstances :warning:
