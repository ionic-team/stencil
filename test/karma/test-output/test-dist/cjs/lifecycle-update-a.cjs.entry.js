...
const LifecycleUpdateA = class {
  ...
  render() {
    return (index.h("div", null, index.h("button", { onClick: this.testClick.bind(this), class: "test" }, "Add Child Components"), index.h("hr", null), this.values.map((value) => {
      return index.h("lifecycle-update-b", { value: value });
    })));
  }
};

exports.lifecycle_update_a = LifecycleUpdateA;
