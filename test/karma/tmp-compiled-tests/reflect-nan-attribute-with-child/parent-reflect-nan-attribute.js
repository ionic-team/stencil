...
exports.ParentReflectNanAttribute = void 0;
var core_1 = require("@stencil/core");
var ParentReflectNanAttribute = /** @class */ (function () {
    function ParentReflectNanAttribute() {
        // counter to proxy the number of times a render has occurred, since we don't have access to those dev tools during
        // karma tests
        this.renderCount = 0;
    }
    ParentReflectNanAttribute.prototype.render = function () {
        this.renderCount += 1;
        return ((0, core_1.h)("div", null,
            (0, core_1.h)("div", null,
                "parent-reflect-nan-attribute Render Count: ",
                this.renderCount),
            (0, core_1.h)("child-reflect-nan-attribute", { val: 'I am not a number!!' })));
    };
    ...
    ParentReflectNanAttribute = __decorate([
        (0, core_1.Component)({
    ...
    return ParentReflectNanAttribute;
}());
exports.ParentReflectNanAttribute = ParentReflectNanAttribute;
