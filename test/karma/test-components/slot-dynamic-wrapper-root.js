...
const SlotDynamicWrapperRoot = /*@__PURE__*/proxyCustomElement(SlotDynamicWrapperRoot$1, [0,"slot-dynamic-wrapper-root",{"tag":[32]}]);
  ...
  components.forEach(cmp => {
    switch(cmp) {
      ...
      case 'slot-dynamic-wrapper':
        ...
        if (!customElements.get(tagName)) {
          const SlotDynamicWrapper$1 = /*@__PURE__*/proxyCustomElement(SlotDynamicWrapper, [0,"slot-dynamic-wrapper-root",{"tag":[32]}]);
