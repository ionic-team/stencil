...
describe('node-globals', function () {
    ...
    beforeEach(function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, setupDom('/node-globals/index.html')];
                case 1:
                    app = _a.sent();
                    return [2 /*return*/];
            }
    ...
    it('expect faked node globals', function () { return __awaiter(_this, void 0, void 0, function () {
        var ids;
        return __generator(this, function (_a) {
            ids = ['tmpdir', 'fs', 'Buffer', 'process'];
            ids.forEach(function (id) {
                var tmpdir = app.querySelector("#".concat(id));
