...
const CssCmp$1 = class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    attachShadow(this);
  ...
  render() {
    return h(
      Host,
      null,
      h('div', { class: 'css-entry' }, 'Css Entry'),
...
const CssCmp = /*@__PURE__*/ proxyCustomElement(CssCmp$1, [1, 'css-cmp']);
    ...
    switch (cmp) {
      case 'css-cmp':
        ...
        if (!customElements.get(tagName)) {
          customElements.define(tagName, CssCmp);
        }
        break;
    }
  });
