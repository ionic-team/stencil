...
const CssCmp = class {
  ...
  render() {
    return (index.h(index.Host, null, index.h("div", { class: "css-entry" }, "Css Entry"), index.h("div", { class: "css-importee" }, "Css Importee"), index.h("hr", null)));
  }
};
CssCmp.style = cssEntryCss;

exports.css_cmp = CssCmp;
