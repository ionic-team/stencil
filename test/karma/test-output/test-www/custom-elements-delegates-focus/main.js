...
/******/ 	__webpack_require__.p = "/custom-elements-delegates-focus/";
/******/
...
// CONCATENATED MODULE: ./test-output/test-custom-elements/custom-elements-delegates-focus.js
...
const CustomElementsDelegatesFocus$1 = /*@__PURE__*/ proxyCustomElement(class extends H {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
const custom_elements_delegates_focus_defineCustomElement = defineCustomElement$1;



// CONCATENATED MODULE: ./test-output/test-custom-elements/custom-elements-no-delegates-focus.js


const custom_elements_no_delegates_focus_sharedDelegatesFocusCss = ":host{display:block;border:5px solid red;padding:10px;margin:10px}:host(:focus){border:5px solid green}input{display:block;width:100%}";

const CustomElementsNoDelegatesFocus$1 = /*@__PURE__*/ proxyCustomElement(class extends H {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get style() { return custom_elements_no_delegates_focus_sharedDelegatesFocusCss; }
}, [1, "custom-elements-no-delegates-focus"]);
function custom_elements_no_delegates_focus_defineCustomElement$1() {
  if (typeof customElements === "undefined") {
    return;
  }
...
const custom_elements_no_delegates_focus_defineCustomElement = custom_elements_no_delegates_focus_defineCustomElement$1;



// CONCATENATED MODULE: ./test-app/custom-elements-delegates-focus/index.esm.js



custom_elements_delegates_focus_defineCustomElement();
custom_elements_no_delegates_focus_defineCustomElement();
