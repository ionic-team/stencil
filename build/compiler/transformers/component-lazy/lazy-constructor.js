 ...
 */
export const updateLazyComponentConstructor = (classMembers, classNode, moduleFile, cmp) => {
...
const registerInstanceStatement = (moduleFile) => {
    ...
    return ts.factory.createExpressionStatement(ts.factory.createCallExpression(ts.factory.createIdentifier(REGISTER_INSTANCE), undefined, [
        ts.factory.createThis(),
        ts.factory.createIdentifier(HOST_REF_ARG),
    ]));
};
//# sourceMappingURL=lazy-constructor.js.map