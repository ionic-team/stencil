 ...
 */
export const insertVdomAnnotations = (doc: d.StencilDocument, staticComponents: string[]) => {
  if (doc != null) {
    doc[HYDRATE_HOST_ID] = HYDRATE_HOST_ID in doc ? doc[HYDRATE_HOST_ID] + 1 : 0;
    const docData: DocData = {
      hostIds: doc[HYDRATE_HOST_ID],
      rootLevelIds: doc[HYDRATE_HOST_ID],
