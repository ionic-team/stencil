...
var AppendChild = /** @class */ function() {
  ...
  return AppendChild.prototype.render = function() {
    return h(Host, null, h("h1", null, "H1 Top", h("slot", {
      name: "h1"
    }), h("div", null, "H1 Bottom")), h("article", null, "Default Top", h("slot", null), "Default Bottom"), h("h6", null, h("section", null, "H6 Top", h("slot", {
      name: "h6"
    }), h("div", null, "H6 Bottom"))));
  }, AppendChild;
}();
