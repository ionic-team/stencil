 ...
 */
const isJest27TransformOptions = (obj) => {
...
let _tsCompilerOptionsKey = null;
...
export function shouldTransform(filePath, sourceText) {
    var _a;
    const ext = ((_a = filePath.split('.').pop()) !== null && _a !== void 0 ? _a : '').toLowerCase().split('?')[0];
...
//# sourceMappingURL=jest-preprocessor.js.map