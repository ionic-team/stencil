...
describe('updateElement', () => {
    ...
    it('should add new classes when no oldVNode.vattrs', () => {
        const elm = document.createElement('my-tag');
        const oldVNode = newVNode('my-component', 'text value');
    ...
    it('should use host element on shadow root element when using shadow dom', () => {
        const elm = {
            ...
            nodeType: 11 /* NODE_TYPE.DocumentFragment */,
        };
        const oldVNode = null;
        const newVnode = createTestNode({
            $flags$: 0,
...
//# sourceMappingURL=update-element.spec.js.map