...
describe('slot array top', function () {
    ...
    it('renders slotted content in the right position for polyfilled elements', function () { return __awaiter(void 0, void 0, void 0, function () {
        var elm, hiddenCmp;
        return __generator(this, function (_a) {
            if (!('attachShadow' in HTMLElement.prototype)) {
                elm = app.querySelector('slot-array-top');
                ...
                hiddenCmp = elm.querySelector('[hidden]');
