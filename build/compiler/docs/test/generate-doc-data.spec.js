...
describe('generate-doc-data', () => {
    describe('getDocsComponents', () => {
        let moduleCmpWithJsdoc;
        let moduleCmpNoJsdoc;
        beforeEach(() => {
         ...
         */
        const setup = (moduleMap) => {
            const validatedConfig = mockValidatedConfig();
            const compilerCtx = mockCompilerCtx(validatedConfig);
            compilerCtx.moduleMap = moduleMap;
            const modules = Array.from(compilerCtx.moduleMap.values());
            const buildCtx = mockBuildCtx(validatedConfig, compilerCtx);
...
//# sourceMappingURL=generate-doc-data.spec.js.map