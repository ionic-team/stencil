...
describe('attribute-basic', function () {
    ...
    beforeEach(function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, setupDom('/input-basic/index.html')];
                case 1:
                    app = _a.sent();
                    return [2 /*return*/];
            }
    ...
    it('should change value prop both ways', function () { return __awaiter(_this, void 0, void 0, function () {
        var cmp, input;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    cmp = app.querySelector('input-basic-root');
