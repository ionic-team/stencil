 ...
 */
export function mockValidatedConfig(overrides = {}) {
    var _a;
    ...
    return {
        ...
        minifyJs: false,
        namespace: 'Testing',
        outputTargets: (_a = baseConfig.outputTargets) !== null && _a !== void 0 ? _a : [],
 ...
 */
export const mockLoadConfigInit = (overrides) => {
    const defaults = {
        config: {},
 ...
 */
export function mockCompilerSystem() {
...
export function mockWindow(html) {
    const win = new MockWindow(html);
    return win;
}
/**
