  ...
  return class_1.prototype.componentWillLoad = function() {
    ...
    return __awaiter(this, void 0, void 0, (function() {
      return __generator(this, (function(e) {
        switch (e.label) {
         case 0:
          return this.lifecycleUpdate.emit("componentWillUpdate-b"), [ 4 /*yield*/ , timeout(100) ];
    ...
    return __awaiter(this, void 0, void 0, (function() {
      return __generator(this, (function(e) {
        switch (e.label) {
         case 0:
          return this.lifecycleUpdate.emit("componentDidUpdate-b"), [ 4 /*yield*/ , timeout(100) ];
    ...
    return this.rendered++, h("div", null, h("hr", null), h("div", null, "LifecycleAsyncB ", this.value), h("div", {
      class: "rendered-b"
    }, "rendered b: ", this.rendered), h("lifecycle-async-c", {
      value: this.value
    }));
  }, class_1;
}();
