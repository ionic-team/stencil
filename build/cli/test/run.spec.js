...
describe('run', () => {
    describe('run()', () => {
        ...
        beforeEach(() => {
            ...
            parseFlagsSpy.mockReturnValue(createConfigFlags({
    ...
    describe('runTask()', () => {
        ...
        let taskGenerateSpy;
        let taskHelpSpy;
        let taskPrerenderSpy;
        let taskServeSpy;
        let taskTelemetrySpy;
        let taskTestSpy;
        beforeEach(() => {
        ...
        describe('default configuration', () => {
            describe('sys property', () => {
                it('uses the sys argument if one is provided', async () => {
                    ...
                    const compilerSystemUsed = taskBuildSpy.mock.calls[0][1].sys;
