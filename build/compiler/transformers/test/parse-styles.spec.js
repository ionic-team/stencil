...
describe('parse styles', () => {
    ...
    it('add static "styles" as object', async () => {
      ...
      export class CmpA {}
    `);
        expect(await formatCode(t.outputText)).toEqual(await formatCode(`const md = 'p{color:red}';const ios = 'p{color:black}';export class CmpA { static get is() { return "cmp-a"; } static get styles() { return { "md": md, "ios": ios }; }}`));
    });
    ...
    it('add static "styles" const', async () => {
      ...
      export class CmpA {}
    `);
        expect(await formatCode(t.outputText)).toEqual(await formatCode(`const styles = 'p{color:red}';export class CmpA { static get is() { return "cmp-a"; } static get styles() { return styles; }}`));
    });
});
//# sourceMappingURL=parse-styles.spec.js.map