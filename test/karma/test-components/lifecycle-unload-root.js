...
const LifecycleUnloadRoot = /*@__PURE__*/proxyCustomElement(LifecycleUnloadRoot$1, [0,"lifecycle-unload-root",{"renderCmp":[32]}]);
  ...
  components.forEach(cmp => {
    switch(cmp) {
      ...
      case 'lifecycle-unload-a':
        ...
        if (!customElements.get(tagName)) {
          const LifecycleUnloadA$1 = /*@__PURE__*/proxyCustomElement(LifecycleUnloadA, [0,"lifecycle-unload-root",{"renderCmp":[32]}]);
      ...
      case 'lifecycle-unload-b':
        ...
        if (!customElements.get(tagName)) {
          const LifecycleUnloadB$1 = /*@__PURE__*/proxyCustomElement(LifecycleUnloadB, [0,"lifecycle-unload-root",{"renderCmp":[32]}]);
