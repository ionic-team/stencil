...
export function responseHeaders(headers, httpCache = false) {
...
export function getDevServerClientUrl(devServerConfig, host, protocol) {
    ...
    return getBrowserUrl(protocol !== null && protocol !== void 0 ? protocol : devServerConfig.protocol, address, port, devServerConfig.basePath, c.DEV_SERVER_URL);
}
...
export function isSsrStaticDataPath(pathname) {
    const parts = pathname.split('/');
    const fileName = parts[parts.length - 1].split('?')[0];
    return fileName === 'page.state.json';
}
export function getSsrStaticDataPath(req) {
...
//# sourceMappingURL=dev-server-utils.js.map