...
describe('mapImportsToPathAliases', () => {
    ...
    it('generates the correct relative path when the resolved module is outside the transpiled project', () => {
        ...
        utils.test();
    `;
        module = transpileModule(inputText, config, null, [], [mapImportsToPathAliases(config, '/dist/collection/test.js', outputTarget)]);
...
//# sourceMappingURL=map-imports-to-path-aliases.spec.js.map