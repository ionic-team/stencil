import { buildError, buildWarn, catchError, isString, join, loadTypeScriptDiagnostic, normalizePath, relative, } from '@utils';
import { isAbsolute } from 'path';
import ts from 'typescript';
export const validateTsConfig = async (config, sys, init) => {
    var _a;
    const tsconfig = {
        path: '',
        compilerOptions: {},
 ...
 */
export const hasSrcDirectoryInclude = (includeProp, src) => Array.isArray(includeProp) &&
