import type { CliInitOptions, Config, TaskCommand, CompilerSystem } from '../declarations';
...
export const runTask = async (coreCompiler: CoreCompiler, config: Config, sys: CompilerSystem, task: TaskCommand) => {
