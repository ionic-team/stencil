...
!(function(undefined) {
  ...
  !(function(t) {
    ...
    function(t, r) {
      ...
      t.exports =
        e(typeof globalThis == n && globalThis) || e(typeof window == n && window) || e(typeof self == n && self) || e(typeof global == n && global) || Function('return this')();
    },
    function(t, r, n) {
      var e = n(1);
      ...
      o('inspectSource', function(t) {
        ...
        (t.exports = function(t, r, n, o) {
          var c = !!o && !!o.unsafe,
            s = !!o && !!o.enumerable,
            f = !!o && !!o.noTargetGet;
          'function' == typeof n && ('string' != typeof r || u(n, 'name') || i(n, 'name', r), (l(n).source = h.join('string' == typeof r ? r : ''))),
            t !== e ? (c ? !f && t[r] && (s = !0) : delete t[r], s ? (t[r] = n) : i(t, r, n)) : s ? (t[r] = n) : a(r, n);
    ...
    function(t, r, n) {
      ...
      t.exports = function(t, r) {
        var n;
        return (
          o(t) && ('function' != typeof (n = t.constructor) || (n !== Array && !o(n.prototype)) ? e(n) && null === (n = n[i]) && (n = void 0) : (n = void 0)),
    ...
    function(t, r, n) {
      ...
      })('versions', []).push({ version: '3.2.0', mode: i ? 'pure' : 'global', copyright: '© 2019 Denis Pushkarev (zloirock.ru)' });
    },
    function(t, r) {
      t.exports = {};
    },
        ...
        if (!p || !v || ('replace' === t && !s) || ('split' === t && !f)) {
          var g = /./[h],
            d = n(h, ''[t], function(t, r, n, e, o) {
              return r.exec === a ? (p && !o ? { done: !0, value: g.call(r, n, e) } : { done: !0, value: t.call(n, r, e) }) : { done: !1 };
            }),
            y = d[0],
            x = d[1];
    ...
    function(t, r, n) {
      ...
      t.exports = function(t, r, n, f, p, x, m) {
        ...
        if (
          (k &&
            ((b = i(k.call(new t()))),
            v !== Object.prototype && b.next && (l || i(b) === v || (u ? u(b, v) : 'function' != typeof b[d] && c(b, d, y)), a(b, O, !0, !0), l && (h[O] = y))),
          'values' == p &&
            R &&
            'values' !== R.name &&
            ((A = !0),
          ...
          if (((S = { values: E('values'), keys: x ? j : E('keys'), entries: E('entries') }), m)) for (w in S) (!g && !A && w in I) || s(I, w, S[w]);
    ...
    function(t, r, n) {
      ...
      t.exports = function(t) {
        var r,
          ...
          y = 0,
          x = s(h);
        if ((d && (g = e(g, v > 2 ? arguments[2] : void 0, 2)), null == x || (p == Array && u(x)))) for (n = new p((r = a(h.length))); r > y; y++) c(n, y, d ? g(h[y], y) : h[y]);
        else for (l = x.call(h), n = new p(); !(f = l.next()).done; y++) c(n, y, d ? i(l, g, [f.value, y], !0) : f.value);
        return (n.length = y), n;
      };
    },
    function(t, r, n) {
      ...
      t.exports = {
        getConstructor: function(t, r, n, s) {
          var f = t(function(t, e) {
              a(t, f, r), v(t, { type: r, index: o(null), first: void 0, last: void 0, size: 0 }), l || (t.size = 0), null != e && c(e, t[s], t, n);
            }),
            p = g(r),
            d = function(t, r, n) {
              var e,
        ...
        (t.exports = {
          getConstructor: function(t, r, n, s) {
            var l = t(function(t, e) {
                a(t, l, r), h(t, { type: r, id: d++, frozen: void 0 }), null != e && c(e, t[s], t, n);
              }),
              v = p(r),
              g = function(t, r, n) {
                var e = v(t),
    ...
    function(t, r, n) {
      ...
      var e = n(0),
        ...
        L = function(t, r) {
          if (r) for (var n, e, o = r.split('&'), i = 0; i < o.length; ) (n = o[i++]).length && ((e = n.split('=')), t.push({ key: A(e.shift()), value: A(e.join('=')) }));
        },
        P = function(t) {
        ...
        N = c(
          function(t, r) {
            x(this, { type: 'URLSearchParamsIterator', iterator: g(m(t).entries), kind: r });
          },
          'Iterator',
          function() {
            var t = b(this),
    ...
    function(t, r, n) {
      ...
      t.exports = function(t) {
        for (
          var r = e(this), n = i(r.length), u = arguments.length, a = o(u > 1 ? arguments[1] : void 0, n), c = u > 2 ? arguments[2] : void 0, s = void 0 === c ? n : o(c, n);
          s > a;
      ...
      e(
        { target: 'Array', proto: !0, forced: !f('slice') },
        {
          slice: function(t, r) {
            ...
            if (
              i(v) &&
              ('function' != typeof (n = v.constructor) || (n !== Array && !i(n.prototype)) ? o(n) && null === (n = n[l]) && (n = void 0) : (n = void 0),
              n === Array || void 0 === n)
            )
              return h.call(v, d, y);
        ...
        { target: 'Array', proto: !0, forced: !f('splice') },
        {
          splice: function(t, r) {
            var n,
              ...
              x = o(t, y),
              m = arguments.length;
            if ((0 === m ? (n = e = 0) : 1 === m ? ((n = 0), (e = y - x)) : ((n = m - 2), (e = h(l(i(r), 0), y - x))), y + n - e > 9007199254740991))
        ...
        for (
          var b = function(t, r) {
              ...
              return !n && e && t.constructor === b && o
                ? t
                : u(m ? new g(e && !o ? t.source : t, r) : g((e = t instanceof b) ? t.source : t, e && o ? f.call(t) : r), n ? this : d, b);
            },
            S = function(t) {
              (t in b) ||
                a(b, t, {
    ...
    function(t, r, n) {
      ...
      var e = n(0),
        ...
        w = o(
          function(t, r, n, e) {
            x(this, { type: 'RegExp String Iterator', regexp: t, string: r, global: n, unicode: e, done: !1 });
          },
          'RegExp String',
          function() {
            var t = m(this);
            ...
            return null === e
              ...
              : t.global
              ? ('' == String(e[0]) && (r.lastIndex = v(n, u(r.lastIndex), t.unicode)), { value: e, done: !1 })
        ...
        E = function(t) {
          ...
          return (
            (r = p(s, RegExp)),
            void 0 === (n = s.flags) && s instanceof RegExp && !('flags' in b) && (n = f.call(s)),
            (e = void 0 === n ? '' : String(n)),
        ...
        { target: 'String', proto: !0 },
        {
          matchAll: function(t) {
            var r,
              ...
              e,
              o = i(this);
            return null != t && (void 0 === (n = t[y]) && d && 'RegExp' == s(t) && (n = E), null != n)
              ? a(n).call(t, o)
              : ((r = String(o)), (e = new RegExp(t, 'g')), d ? E.call(e, r) : e[y](r));
          },
        },
      ),
        d || y in b || l(b, y, E);
              ...
              ''.split(/.?/).length
                ? function(t, n) {
                    ...
                    for (
                      ...
                      !(
                        (c = g.lastIndex) > v &&
                        (f.push(e.slice(v, a.index)), a.length > 1 && a.index < e.length && p.apply(f, a.slice(1)), (s = a[0].length), (v = c), f.length >= i)
                      );
    ...
    function(t, r, n) {
      ...
      var e,
        ...
        z = function(t) {
          ...
          if (null !== f) for (u = s - f, s = 7; 0 != s && u > 0; ) (a = c[s]), (c[s--] = c[f + u - 1]), (c[f + --u] = a);
          else if (8 != s) return;
          return c;
        },
        q = function(t) {
        ...
        Ot = function() {
          var t = E(this),
            ...
            s = r + ':';
          return (
            null !== o ? ((s += '//'), J(t) && (s += n + (e ? ':' + e : '') + '@'), (s += q(o)), null !== i && (s += ':' + i)) : 'file' == r && (s += '//'),
