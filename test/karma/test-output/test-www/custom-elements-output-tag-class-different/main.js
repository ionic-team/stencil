...
/******/ 	__webpack_require__.p = "/custom-elements-output-tag-class-different/";
/******/
...
// CONCATENATED MODULE: ./test-output/test-custom-elements/custom-element-child3.js
...
function custom_element_child3_defineCustomElement() {
...
// CONCATENATED MODULE: ./test-output/test-custom-elements/custom-element-root-different-name-than-class.js



const CustomElementRoot = /*@__PURE__*/ proxyCustomElement(class extends H {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
function defineCustomElement$1() {
  ...
  components.forEach(tagName => { switch (tagName) {
    ...
    case "custom-element-child-different-name-than-class":
      if (!customElements.get(tagName)) {
        custom_element_child3_defineCustomElement();
      }
      break;
  } });
}
...
const custom_element_root_different_name_than_class_defineCustomElement = defineCustomElement$1;



// CONCATENATED MODULE: ./test-app/custom-elements-output-tag-class-different/index.esm.js


custom_element_root_different_name_than_class_defineCustomElement();
