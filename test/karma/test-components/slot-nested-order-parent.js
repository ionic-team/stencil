...
const SlotNestedOrderParent = /*@__PURE__*/proxyCustomElement(SlotNestedOrderParent$1, [4,"slot-nested-order-parent"]);
  ...
  components.forEach(cmp => {
    switch(cmp) {
      ...
      case 'slot-nested-order-child':
        ...
        if (!customElements.get(tagName)) {
          const SlotNestedOrderChild$1 = /*@__PURE__*/proxyCustomElement(SlotNestedOrderChild, [4,"slot-nested-order-parent"]);
