...
const SlotReorderRoot = /*@__PURE__*/proxyCustomElement(SlotReorderRoot$1, [0,"slot-reorder-root",{"reordered":[32]}]);
  ...
  components.forEach(cmp => {
    switch(cmp) {
      ...
      case 'slot-reorder':
        ...
        if (!customElements.get(tagName)) {
          const SlotReorder$1 = /*@__PURE__*/proxyCustomElement(SlotReorder, [0,"slot-reorder-root",{"reordered":[32]}]);
