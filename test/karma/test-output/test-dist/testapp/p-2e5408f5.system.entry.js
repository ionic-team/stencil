...
System.register([ "./p-329d5583.system.js" ], (function(t) {
  ...
  return {
    ...
    execute: function() {
      t("lifecycle_async_a", /** @class */ function() {
        function class_1(t) {
          e(this, t), this.rendered = 0, this.componentWillUpdated = !1, this.componentDidUpdated = !1, 
        ...
        return class_1.prototype.lifecycleLoad = function(t) {
          ...
          return this.rendered++, r("div", null, r("button", {
            onClick: this.testClick.bind(this),
            class: "test"
          }, "Update"), r("hr", null), r("div", null, "LifecycleAsyncA ", this.value), r("div", {
            class: "rendered-a"
          }, "rendered a: ", this.rendered), r("div", null, "loads a:"), r("ol", {
            class: "lifecycle-loads-a"
          }, this.loads.map((function(t) {
            return r("li", null, t);
          }))), r("div", null, "updates a:"), r("ol", {
