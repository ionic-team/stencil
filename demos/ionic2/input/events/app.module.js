...
var E2EPage = (function () {
    ...
    E2EPage.prototype.input2 = function () {
        this.value2 = this.ngvalue2;
        console.log('value2', this.value2);
    };
    E2EPage.prototype.input3 = function (ref) {
        this.value3 = ref.value;
        console.log('value3', this.value3);
    };
    E2EPage.prototype.input4 = function (value) {
        this.value4 = value;
        console.log('value4', this.value4);
    };
    E2EPage.prototype.input5 = function (ev) {
        this.value5 = ev.target.value;
        console.log('value5', this.value5);
    };
    E2EPage.prototype.input6 = function (value) {
        this.value6 = value;
