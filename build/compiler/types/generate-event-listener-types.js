 ...
 */
export const generateEventListenerTypes = (cmp, typeImportData) => {
 ...
 */
const getHtmlElementEventMap = (cmpEvents, typeImportData, sourceFilePath, htmlElementEventMapName) => {
 ...
 */
const getEventGenericType = (cmpEvent, typeImportData, componentSourcePath) => {
    return updateTypeIdentifierNames(cmpEvent.complexType.references, typeImportData, componentSourcePath, cmpEvent.complexType.original);
};
//# sourceMappingURL=generate-event-listener-types.js.map