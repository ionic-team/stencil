...
describe('es5 $addClass svg', function () {
    ...
    beforeEach(function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, setupDom('/es5-addclass-svg/index.html')];
                case 1:
                    app = _a.sent();
    ...
    it('should add a class', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
    ...
    function testNativeShadow(result) {
        var svg = result.shadowRoot.querySelector('svg');
    ...
    function testPolyfilledShadow(result) {
