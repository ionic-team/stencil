...
import { createInMemoryFs, getCommitInstructions, shouldIgnore } from '../in-memory-fs';
describe(`in-memory-fs, getCommitInstructions`, () => {
    ...
    it(`dirsToDelete, sort longest to shortest, windows`, () => {
        ...
        expect((_a = items.get(`C:/dir1`)) === null || _a === void 0 ? void 0 : _a.queueDeleteFromDisk).toBe(false);
        expect((_b = items.get(`C:/dir1/dir2`)) === null || _b === void 0 ? void 0 : _b.queueDeleteFromDisk).toBe(false);
        expect((_c = items.get(`C:/dir1/dir2/dir3`)) === null || _c === void 0 ? void 0 : _c.queueDeleteFromDisk).toBe(false);
    });
    it(`dirsToDelete, sort longest to shortest, unix`, () => {
        ...
        expect(i.dirsToEnsure).toEqual([]);
        expect((_a = items.get(`/dir1`)) === null || _a === void 0 ? void 0 : _a.queueDeleteFromDisk).toBe(false);
        expect((_b = items.get(`/dir1/dir2`)) === null || _b === void 0 ? void 0 : _b.queueDeleteFromDisk).toBe(false);
        expect((_c = items.get(`/dir1/dir2/dir3`)) === null || _c === void 0 ? void 0 : _c.queueDeleteFromDisk).toBe(false);
    });
    it(`ensure dirs, sort shortest to longest, windows`, () => {
        ...
        expect((_a = items.get(`C:/dir1`)) === null || _a === void 0 ? void 0 : _a.queueDeleteFromDisk).toBe(false);
        expect((_b = items.get(`C:/dir1/dir2/file1.js`)) === null || _b === void 0 ? void 0 : _b.queueDeleteFromDisk).toBe(false);
        expect((_c = items.get(`C:/dir1/dir2/dir3/file2.js`)) === null || _c === void 0 ? void 0 : _c.queueDeleteFromDisk).toBe(false);
    });
    it(`ensure dirs, sort shortest to longest`, () => {
        ...
        expect((_a = items.get(`/dir1`)) === null || _a === void 0 ? void 0 : _a.queueDeleteFromDisk).toBe(false);
        expect((_b = items.get(`/dir1/dir2/file1.js`)) === null || _b === void 0 ? void 0 : _b.queueDeleteFromDisk).toBe(false);
        expect((_c = items.get(`/dir1/dir2/dir3/file2.js`)) === null || _c === void 0 ? void 0 : _c.queueDeleteFromDisk).toBe(false);
    });
    it(`do not delete a files/directory if we also want to ensure it`, () => {
        ...
        expect((_a = items.get(`/dir1/file1.js`)) === null || _a === void 0 ? void 0 : _a.queueWriteToDisk).toBe(false);
    });
    it(`queueDeleteFromDisk`, () => {
        ...
        expect(i.dirsToEnsure).toEqual([]);
        expect((_a = items.get(`/dir1`)) === null || _a === void 0 ? void 0 : _a.queueDeleteFromDisk).toBe(false);
        expect((_b = items.get(`/dir1/file1.js`)) === null || _b === void 0 ? void 0 : _b.queueDeleteFromDisk).toBe(false);
        expect((_c = items.get(`/dir2/file2.js`)) === null || _c === void 0 ? void 0 : _c.queueDeleteFromDisk).toBe(false);
        expect((_d = items.get(`/dir1`)) === null || _d === void 0 ? void 0 : _d.queueDeleteFromDisk).toBe(false);
    });
    it(`write directory to disk`, () => {
        ...
        expect(i.dirsToDelete).toEqual([]);
        expect(i.dirsToEnsure).toEqual([`/dir1`]);
        expect((_a = items.get(`/dir1`)) === null || _a === void 0 ? void 0 : _a.queueWriteToDisk).toBe(false);
    });
    ...
    it(`write file queued`, () => {
        ...
        expect((_a = items.get(`/dir1/file1.js`)) === null || _a === void 0 ? void 0 : _a.queueWriteToDisk).toBe(false);
        expect((_b = items.get(`/dir1/file2.js`)) === null || _b === void 0 ? void 0 : _b.queueWriteToDisk).toBe(false);
        expect((_c = items.get(`/dir2/file3.js`)) === null || _c === void 0 ? void 0 : _c.queueWriteToDisk).toBe(false);
    });
    it(`do nothing`, () => {
        const i = getCommitInstructions(items);
        expect(i.filesToDelete).toEqual([]);
...
//# sourceMappingURL=in-memory-fs.spec.js.map