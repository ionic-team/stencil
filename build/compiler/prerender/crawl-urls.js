...
export const crawlAnchorsForNextUrls = (prerenderConfig, diagnostics, baseUrl, currentUrl, parsedAnchors) => {
...
export const standardNormalizeHref = (prerenderConfig, diagnostics, url) => {
    try {
...
//# sourceMappingURL=crawl-urls.js.map