...
describe('minifyCss', () => {
    ...
    it('font-face url hash', async () => {
      ...
      `,
        ...
        expect(c).toBe(`@font-face{font-family:"Open Sans";src:url("/font.woff2?mph=88") format("woff2"),url('/font.woff?mph=88') format('woff')}`);
    });
});
//# sourceMappingURL=minify-css.spec.js.map