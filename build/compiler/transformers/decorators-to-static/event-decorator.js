...
import { convertValueToLiteral, createStaticGetter, getAttributeTypeInfo, resolveType, retrieveTsDecorators, serializeSymbol, validateReferences, } from '../transform-utils';
import { getDecoratorParameters, isDecoratorNamed } from './decorator-utils';
export const eventDecoratorsToStatic = (diagnostics, decoratedProps, typeChecker, program, newMembers) => {
 ...
 */
const parseEventDecorator = (diagnostics, typeChecker, program, prop) => {
    var _a;
    ...
    const [eventOpts] = getDecoratorParameters(eventDecorator, typeChecker);
 ...
 */
const getComplexType = (typeChecker, program, node) => {
