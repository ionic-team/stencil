...
describe('lifecycle-nested', function () {
    ...
    beforeEach(function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, setupDom('/lifecycle-nested/index.html')];
                case 1:
                    app = _a.sent();
                    return [2 /*return*/];
            }
    ...
    it('fire load methods in order for nested elements', function () { return __awaiter(_this, void 0, void 0, function () {
        var loads;
        return __generator(this, function (_a) {
            loads = app.querySelectorAll('.lifecycle-loads li');
