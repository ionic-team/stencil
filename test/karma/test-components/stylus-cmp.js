...
const StylusCmp$1 = class extends HTMLElement {
  ...
  render() {
    return h(
      Host,
      null,
      h('div', { class: 'stylus-entry' }, 'Stylus Entry'),
      h('div', { class: 'stylus-importee' }, 'Stylus Importee'),
      h('div', { class: 'css-importee' }, 'Css Importee'),
      h('hr', null)
    );
  }
  static get style() {
    return stylusEntryCss;
  }
};
