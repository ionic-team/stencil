...
content = `(function(win, doc, namespace, fsNamespace, resourcePath, appCore, appCoreSsr, appCorePolyfilled, hydratedCssClass, components) {

${content}

init(win, doc, namespace, fsNamespace, resourcePath, appCore, appCoreSsr, appCorePolyfilled, hydratedCssClass, components);
