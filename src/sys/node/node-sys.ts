...
export function createNodeSys(c: { process?: any } = {}): CompilerSystem {
  ...
  sys.lazyRequire = new NodeLazyRequire(nodeResolve, {
    '@types/jest': { minVersion: '24.9.1', recommendedVersion: '27.0.3', maxVersion: '28' },
    jest: { minVersion: '24.9.1', recommendedVersion: '27.0.3', maxVersion: '28' },
    'jest-cli': { minVersion: '24.9.0', recommendedVersion: '27.4.5', maxVersion: '28' },
