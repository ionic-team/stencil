...
const SlotDynamicShadowList = /*@__PURE__*/proxyCustomElement(DynamicListShadowComponent, [1,"slot-dynamic-shadow-list",{"items":[16]}]);
  ...
  components.forEach(cmp => {
    switch(cmp) {
      ...
      case 'slot-light-list':
        ...
        if (!customElements.get(tagName)) {
          const SlotLightList$1 = /*@__PURE__*/proxyCustomElement(SlotLightList, [1,"slot-dynamic-shadow-list",{"items":[16]}]);
