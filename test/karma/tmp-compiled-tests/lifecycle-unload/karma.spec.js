...
describe('lifecycle-unload', function () {
    ...
    beforeEach(function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, setupDom('/lifecycle-unload/index.html')];
                case 1:
                    app = _a.sent();
                    return [2 /*return*/];
            }
    ...
    it('fire unload methods', function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!('shadowRoot' in HTMLElement.prototype)) return [3 /*break*/, 2];
                    return [4 /*yield*/, testNativeShadowDom()];
                case 1:
                    _a.sent();
                    return [3 /*break*/, 4];
                case 2: return [4 /*yield*/, testSlotPolyfill()];
                case 3:
                    _a.sent();
                    _a.label = 4;
    ...
    function testNativeShadowDom() {
        return __awaiter(this, void 0, void 0, function () {
            var main, unload, button, cmpA;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        _a.sent();
                        cmpA = app.querySelector('lifecycle-unload-a');
