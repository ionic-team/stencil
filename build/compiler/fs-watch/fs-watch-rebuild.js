 ...
 */
export const hasScriptExt = (filePath) => {
 ...
 */
export const hasStyleExt = (filePath) => {
    const ext = getExt(filePath);
 ...
 */
export const scriptsAdded = (buildCtx) => buildCtx.filesAdded.filter(hasScriptExt).map(unaryBasename);
/**
 ...
 */
export const scriptsDeleted = (buildCtx) => buildCtx.filesDeleted.filter(hasScriptExt).map(unaryBasename);
/**
 ...
 */
export const hasScriptChanges = (buildCtx) => buildCtx.filesChanged.some(hasScriptExt);
/**
 ...
 */
export const hasStyleChanges = (buildCtx) => buildCtx.filesChanged.some(hasStyleExt);
/**
...
export const isWatchIgnorePath = (config, path) => {
    if (isString(path)) {
...
//# sourceMappingURL=fs-watch-rebuild.js.map