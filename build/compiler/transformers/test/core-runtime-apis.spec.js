...
describe('addCoreRuntimeApi()', () => {
    ...
    beforeEach(() => {
        ...
        mockModule = createModule(ts.createSourceFile('mock-file.ts', sourceText, ts.ScriptTarget.ES5), sourceText, 'mock-file.js');
    });
...
//# sourceMappingURL=core-runtime-apis.spec.js.map